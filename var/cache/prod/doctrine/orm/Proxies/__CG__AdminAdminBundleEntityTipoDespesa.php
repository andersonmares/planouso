 ...
 */
class TipoDespesa extends \Admin\AdminBundle\Entity\TipoDespesa implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Admin\\AdminBundle\\Entity\\TipoDespesa' . "\0" . 'id', '' . "\0" . 'Admin\\AdminBundle\\Entity\\TipoDespesa' . "\0" . 'dsTipoDespesa', '' . "\0" . 'Admin\\AdminBundle\\Entity\\TipoDespesa' . "\0" . 'dtCadastro', '' . "\0" . 'Admin\\AdminBundle\\Entity\\TipoDespesa' . "\0" . 'dtAtualizacao', '' . "\0" . 'Admin\\AdminBundle\\Entity\\TipoDespesa' . "\0" . 'stRegistroAtivo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TipoDespesa $proxy) {
    ...
    public function setDsTipoDespesa($dsTipoDespesa)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDsTipoDespesa', [$dsTipoDespesa]);

        return parent::setDsTipoDespesa($dsTipoDespesa);
    }
    ...
    public function getDsTipoDespesa()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDsTipoDespesa', []);

        return parent::getDsTipoDespesa();
    }
