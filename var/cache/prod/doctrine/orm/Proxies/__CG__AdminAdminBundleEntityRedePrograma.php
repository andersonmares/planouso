 ...
 */
class RedePrograma extends \Admin\AdminBundle\Entity\RedePrograma implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Admin\\AdminBundle\\Entity\\RedePrograma' . "\0" . 'departamento', '' . "\0" . 'Admin\\AdminBundle\\Entity\\RedePrograma' . "\0" . 'id', '' . "\0" . 'Admin\\AdminBundle\\Entity\\RedePrograma' . "\0" . 'coDepartamento', '' . "\0" . 'Admin\\AdminBundle\\Entity\\RedePrograma' . "\0" . 'dsRedePrograma', '' . "\0" . 'Admin\\AdminBundle\\Entity\\RedePrograma' . "\0" . 'dtCadastro', '' . "\0" . 'Admin\\AdminBundle\\Entity\\RedePrograma' . "\0" . 'dtAtualizacao', '' . "\0" . 'Admin\\AdminBundle\\Entity\\RedePrograma' . "\0" . 'stRegistroAtivo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RedePrograma $proxy) {
    ...
    public function setDsRedePrograma($dsRedePrograma)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDsRedePrograma', [$dsRedePrograma]);

        return parent::setDsRedePrograma($dsRedePrograma);
    }
    ...
    public function getDsRedePrograma()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDsRedePrograma', []);

        return parent::getDsRedePrograma();
    }
