...
class appProdProjectContainer extends Container
{
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $instance->setHost('smtpaplicacao.saude.gov');
        $instance->setPort(25);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(${($_ = isset($this->services['debug.file_link_formatter']) ? $this->services['debug.file_link_formatter'] : $this->services['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL)) && false ?: '_'}, 'D:\\planouso\\app', 'UTF-8'));
    ...
    {
        $this->services['monolog.handler.deduplicated'] = $instance = new \Monolog\Handler\DeduplicationHandler(${($_ = isset($this->services['monolog.handler.swift']) ? $this->services['monolog.handler.swift'] : $this->getMonolog_Handler_SwiftService()) && false ?: '_'}, ($this->targetDirs[0].'/monolog_dedup_922a7b2c3485f2fca0b658c7a9e614d9d914a2f5'), 400, 60, true);
    ...
    {
        $this->services['monolog.handler.main'] = $instance = new \Monolog\Handler\FingersCrossedHandler(${($_ = isset($this->services['monolog.handler.deduplicated']) ? $this->services['monolog.handler.deduplicated'] : $this->getMonolog_Handler_DeduplicatedService()) && false ?: '_'}, 500, 0, true, true, NULL);
    ...
    protected function getMonolog_Handler_SwiftService()
    {
        ...
        $instance->setTransport(${($_ = isset($this->services['swiftmailer.mailer.default.transport.real']) ? $this->services['swiftmailer.mailer.default.transport.real'] : $this->getSwiftmailer_Mailer_Default_Transport_RealService()) && false ?: '_'});
    ...
    {
        return $this->services['monolog.handler.swift.mail_message_factory'] = new \Symfony\Bundle\MonologBundle\SwiftMailer\MessageFactory(${($_ = isset($this->services['swiftmailer.mailer.default']) ? $this->services['swiftmailer.mailer.default'] : $this->getSwiftmailer_Mailer_DefaultService()) && false ?: '_'}, 'fabio.teixeira@saude.gov.br', array(0 => 'fabio.teixeira@saude.gov.br'), 'Erro plano de uso! %message%', 'text/html');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'session.save_path' => 'D:\\planouso/var/sessions/prod',
            ...
            'router.resource' => 'D:\\planouso/app/config/routing.yml',
