 ...
 */
class TipoComponente extends \Admin\AdminBundle\Entity\TipoComponente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Admin\\AdminBundle\\Entity\\TipoComponente' . "\0" . 'id', '' . "\0" . 'Admin\\AdminBundle\\Entity\\TipoComponente' . "\0" . 'dsTipoComponente', '' . "\0" . 'Admin\\AdminBundle\\Entity\\TipoComponente' . "\0" . 'dtCadastro', '' . "\0" . 'Admin\\AdminBundle\\Entity\\TipoComponente' . "\0" . 'dtAtualizacao', '' . "\0" . 'Admin\\AdminBundle\\Entity\\TipoComponente' . "\0" . 'stRegistroAtivo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TipoComponente $proxy) {
    ...
    public function setDsTipoComponente($dsTipoComponente)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDsTipoComponente', [$dsTipoComponente]);

        return parent::setDsTipoComponente($dsTipoComponente);
    }
    ...
    public function getDsTipoComponente()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDsTipoComponente', []);

        return parent::getDsTipoComponente();
    }
