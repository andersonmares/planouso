 ...
 */
class VinculoPlanejamento extends \Admin\AdminBundle\Entity\VinculoPlanejamento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Admin\\AdminBundle\\Entity\\VinculoPlanejamento' . "\0" . 'id', '' . "\0" . 'Admin\\AdminBundle\\Entity\\VinculoPlanejamento' . "\0" . 'dsVinculoPlanejamento', '' . "\0" . 'Admin\\AdminBundle\\Entity\\VinculoPlanejamento' . "\0" . 'dtCadastro', '' . "\0" . 'Admin\\AdminBundle\\Entity\\VinculoPlanejamento' . "\0" . 'dtAtualizacao', '' . "\0" . 'Admin\\AdminBundle\\Entity\\VinculoPlanejamento' . "\0" . 'stRegistroAtivo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VinculoPlanejamento $proxy) {
    ...
    public function setDsVinculoPlanejamento($dsVinculoPlanejamento)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDsVinculoPlanejamento', [$dsVinculoPlanejamento]);

        return parent::setDsVinculoPlanejamento($dsVinculoPlanejamento);
    }
    ...
    public function getDsVinculoPlanejamento()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDsVinculoPlanejamento', []);

        return parent::getDsVinculoPlanejamento();
    }
