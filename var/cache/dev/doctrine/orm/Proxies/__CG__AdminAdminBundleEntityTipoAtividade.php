 ...
 */
class TipoAtividade extends \Admin\AdminBundle\Entity\TipoAtividade implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Admin\\AdminBundle\\Entity\\TipoAtividade' . "\0" . 'id', '' . "\0" . 'Admin\\AdminBundle\\Entity\\TipoAtividade' . "\0" . 'dsTipoAtividade', '' . "\0" . 'Admin\\AdminBundle\\Entity\\TipoAtividade' . "\0" . 'dtCadastro', '' . "\0" . 'Admin\\AdminBundle\\Entity\\TipoAtividade' . "\0" . 'dtAtualizacao', '' . "\0" . 'Admin\\AdminBundle\\Entity\\TipoAtividade' . "\0" . 'stRegistroAtivo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TipoAtividade $proxy) {
    ...
    public function setDsTipoAtividade($dsTipoAtividade)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDsTipoAtividade', [$dsTipoAtividade]);

        return parent::setDsTipoAtividade($dsTipoAtividade);
    }
    ...
    public function getDsTipoAtividade()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDsTipoAtividade', []);

        return parent::getDsTipoAtividade();
    }
