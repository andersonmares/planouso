 ...
 * @ORM\Entity(repositoryClass="Admin\AdminBundle\Repository\PerfilAcessoRepository")
 */
class PerfilAcesso
{
    /**
     ...
     * @ORM\SequenceGenerator(sequenceName="DBPROPOSTASAS.SQ_PERFILACESSO_COSEQPERFLACSS")
     */
    private $id;
