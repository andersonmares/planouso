...
class RedeProgramaController extends Controller
{
    ...
    public function addAction(Request $request){
        ...
        if ($form->isSubmitted() && $form->isValid()){
            ...
            try{
                ...
                $this->addFlash("success", "Política/Programa/Rede registrado com sucesso!");
            }catch (\Exception $e)            {
                $doctrine->getConnection()->rollBack();
                $this->addFlash("error", "Algum erro ocorreu a tentar registrar a Política/Programa/Rede");
                throw $e;
            }
    ...
    public function editAction(RedePrograma $redeprograma, Request $request){
        ...
        if ($form->isValid() && $form->isSubmitted()){
            ...
            $this->addFlash("success", "Política/Programa/Rede editado com sucesso!");
            return $this->redirectToRoute('redeprograma');
        }
    ...
    public function disableAction(Request $request, $id = null){
        ...
        if(!$redeprograma){
            throw $this->createNotFoundException(
                'A Política/Programa/Rede selecionada, não foi encontrada!'
            );
        }
        ...
        $em->flush();
        $this->addFlash("success", "Política/Programa/Rede desativado com sucesso!");
