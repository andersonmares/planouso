...
class TipoAtividadeController extends Controller
{
    ...
    public function addAction(Request $request){
        ...
        if ($form->isSubmitted() && $form->isValid()){
            ...
            try{
                ...
                $this->addFlash("success", "Ano de Referência registrado com sucesso!");
            }catch (\Exception $e)            {
                $doctrine->getConnection()->rollBack();
                $this->addFlash("error", "Algum erro ocorreu a tentar registrar o Ano de Referência");
                throw $e;
            }
    ...
    public function editAction(TipoAtividade $componente, Request $request){
        ...
        if ($form->isValid() && $form->isSubmitted()){
            ...
            $this->addFlash("success", "Ano de Referência editado com sucesso!");
            return $this->redirectToRoute('tipoatividade');
        }
    ...
    public function disableAction(Request $request, $id = null){
        ...
        if(!$atividade){
            throw $this->createNotFoundException(
                'O Ano de Referência selecionado, não foi encontrada!'
            );
        }
        ...
        $em->flush();
        $this->addFlash("success", "Ano de Referência desativado com sucesso!");
