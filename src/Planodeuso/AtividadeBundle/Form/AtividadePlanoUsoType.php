...
namespace Planodeuso\AtividadeBundle\Form;
...
class AtividadePlanoUsoType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('redePrograma', EntityType::class, array(
                ...
                'query_builder' => function (RedeProgramaRepository $er) use($options){
                    return $er->createQueryBuilder('r')
                        ->innerJoin('\Admin\AdminBundle\Entity\Departamento', 'd', 'WITH', 'd.id = r.coDepartamento and d.stRegistroAtivo = :stRegistroAtivo')
                        ->where('r.stRegistroAtivo = :stRegistroAtivo and r.coDepartamento = :coDepartamento')
                        ->orderBy('r.dsRedePrograma')
                        ->setParameter('stRegistroAtivo', 'S')
                        ->setParameter('coDepartamento', $options['coDepartamento']);
                },
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Planodeuso\AtividadeBundle\Entity\AtividadePlanoUso',
            'vlSaldo' => null,
            'coDepartamento' => null
        ));
    }
